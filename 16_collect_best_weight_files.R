...
new_wgt_dir = "xtune_fusion_models/Whole_Blood/cis_MatrixeQTL_GBAT_transPCO/"
...
fwrite(pos_matrix,"pos_files/Whole_Blood/cis_MatrixeQTL_GBAT_transPCO.pos",sep = '\t', quote = F, col.names = T, row.names = F)
