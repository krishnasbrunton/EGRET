...
new_wgt_dir = "xtune_fusion_models/Whole_Blood/cis_transPCO/"
...
fwrite(pos_matrix,paste0(pos_dir,"cis_transPCO.pos"),sep = '\t', quote = F, col.names = T, row.names = F)
