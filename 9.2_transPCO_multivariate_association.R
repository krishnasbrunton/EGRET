...
results_dir = paste0(base_dir, "/PCO_association_results")
...
for (module in modules) {
  ...
  genes_in_module = fread(file.path(modules_dir, module), header = FALSE)
  ...
  for (chr in 1:22) {
    ...
    genes_in_module = genes_in_module[V1 %in% valid_genes, ]
    ...
    # Read Z matrix
    z_matrix_path = paste0(base_dir, "/association_results/matrix_", module_name, "_chr_", chr, ".txt.gz")
